...
namespace SHM_MS.Migrations
{
    ...
    [Migration("20250610032133_CreateIndexForVmIdAndTimestampOnReports")]
    partial class CreateIndexForVmIdAndTimestampOnReports
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SHM_MS.Models.Report", b =>
                {
                    ...
                    b.HasIndex("VmId", "Timestamp")
                        .HasDatabaseName("ix_reports_vm_id_timestamp");
